 ...
 * For this Feature the Test Scenarios are: 
	1. Check for the user if it can proceed to WP after Login 
	2. Test if "Page" link is editable 
	3. Test if "Home" can be edited 
	4. Test if any new module can be added 
	5. Test to create a new Generic module 
	6. Test to save the created Generic Module 
	7. Test to verify Generic Module in Frontend 
	8, Test to verify the deletion of Generic Module 
 * **/

package com.yell;

public class S_MKT_435_Test extends CommonMethods
{
	@Override
